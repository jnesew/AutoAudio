...
If you want, next I can generate the same backlog in a checkbox GitHub issue template format (- [ ]) so you can paste directly into a tracking issue/Projects board.
