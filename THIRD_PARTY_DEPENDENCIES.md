...
|---|---|---|---|
| pubparser | exact commit `2e6c83a` (`0.2.0.dev0`) | MIT | EPUB parsing, metadata, cover discovery, Project Gutenberg normalization, document semantics, and conservative TOC identification. |
